...
OUTPUT_DIR = "/lustre/scratch113/projects/ddd/users/as33/Indelible/DDD4k/"
...
@transform(score_positions,suffix(".sr_reads.counts.scored"),".sr_reads.counts.scored.annotated")
