...
splitfile = open(sys.argv[1],'r')
bam_file = pysam.Samfile(sys.argv[2],'rb')
reference = Fasta(sys.argv[3],as_raw=True)
...
header = ("chrom","position","coverage","insertion_context","deletion_context",
			  ...
			  "avg_avg_sr_qual","avg_mapq")
outputfile = open(sys.argv[1]+".counts",'w')
