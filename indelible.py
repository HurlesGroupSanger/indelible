...
if args.command == "complete":
    ...
    if args.keep_tmp != True:
        ...
        os.remove(args.output_path+"/score.lst")
        os.remove(args.output_path+"/maf_db.txt.1.fastq")
        os.remove(args.output_path+"/maf_db.txt.2.fastq")
        os.remove(args.output_path+"/maf_db.txt.fasta")
        os.remove(args.output_path+"/maf_db.txt.sam")